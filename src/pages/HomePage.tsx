  ...
  return (
    <div>
      {!isFiltering && (
        <>
          <header className="text-center my-10">
            <h1 className="text-5xl font-extrabold text-gray-900">Bienvenido a <span className="text-primary">LocalTech</span></h1>
            <p className="text-lg text-gray-600 mt-2">La mejor tecnología, directo a tu casa.</p>
          </header>
          <FeaturedCarousel />
        </>
      )}
      <div className="container mx-auto p-6">
        <main>
           <section>
            <h2 className="text-3xl font-bold text-gray-800 mb-6">{isFiltering ? 'Resultados de la Búsqueda' : 'Nuestro Catálogo'}</h2>
            {loading ? (
