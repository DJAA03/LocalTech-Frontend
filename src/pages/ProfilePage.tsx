    ...
    return (
        <div className="container mx-auto p-4 md:p-6 max-w-2xl">
            ...
            <div className="bg-white p-6 md:p-8 rounded-lg shadow-md mb-8 border border-gray-200">
                <h2 className="text-xl font-semibold mb-6 text-gray-900 flex items-center gap-3"><User className="text-primary"/>Datos Personales</h2>
                <form onSubmit={handleNameUpdate} className="space-y-4">
                    ...
                    <div className="pt-2">
                        <button type="submit" className="w-full sm:w-auto bg-primary text-white font-bold py-2 px-4 rounded-md hover:bg-primary-hover flex items-center justify-center gap-2">
            ...
            <div className="bg-white p-6 md:p-8 rounded-lg shadow-md border border-gray-200">
                <h2 className="text-xl font-semibold mb-6 text-gray-900 flex items-center gap-3"><Lock className="text-primary"/>Cambiar Contraseña</h2>
