            ...
            <div className="w-full max-w-md p-8 space-y-6 bg-white rounded-lg shadow-md">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    <div>
                        ...
                        <input type="text" value={nombre} onChange={(e) => setNombre(e.target.value)} required className="w-full px-3 py-2 mt-1 border rounded-md focus:ring-primary focus:border-primary"/>
                    </div>
                    <div>
                ...
                <div className="text-center mt-4 border-t pt-4">
                    <Link to="/register-admin" className="text-xs text-gray-500 hover:text-primary hover:underline">
